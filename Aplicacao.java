    ...
    public static void main(String[] args) {
        ...
        if ("PF".equalsIgnoreCase(tipo)) {
            ...
            if ("CRIAR".equalsIgnoreCase(cren)) {
                ...
                int cpf = ler.nextInt();
                Pf pf = new Pf(nome, 9999, 3000, cpf);
            ...
            if ("CRIAR".equalsIgnoreCase(cren)) {
                ...
                Pj pj = new Pj(nome, 00000, 3000, cnpj);
